...
PetApp.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new PetApp.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
PetApp.TabelaClientePesquisaRapida = (function() {
...
$(function() {
	var pesquisaRapidaCliente = new PetApp.PesquisaRapidaCliente();
