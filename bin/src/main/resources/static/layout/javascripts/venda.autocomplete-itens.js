...
PetApp.Autocomplete = (function() {
	
	function Autocomplete() {
		this.skuOuNomeInput = $('.js-produto-input');
	...
	Autocomplete.prototype.iniciar = function() {
		var options = {
			url: function(skuOuNome) {
				return this.skuOuNomeInput.data('url') + '?pesquisaPorNome=' + skuOuNome;
			}.bind(this),
	...
	function template(nome, produto) {
		produto.valorFormatado = PetApp.formatarMoeda(produto.valorVenda);
